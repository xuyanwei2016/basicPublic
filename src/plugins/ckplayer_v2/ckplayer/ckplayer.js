...
! (function() {
	...
	var ckplayer = function(obj) {
		...
		*/
		...
		this.videoScale = 1;
		//全局变量：设置字体
		// this.fontFamily = '"Microsoft YaHei"; YaHei; "\5FAE\8F6F\96C5\9ED1"; SimHei; "\9ED1\4F53";Arial'; // gyy
		//全局变量：设置字幕的文字大小
		...
		getVideo: function() {
			...
			if (this.html5Video) { //如果支持HTML5-VIDEO则默认使用HTML5-VIDEO播放器
				...
				if (this.isM3u8) {
					...
					this.loadJs('//zgsccbs.com/skz/hls.js', loadJsHandler);
				}
